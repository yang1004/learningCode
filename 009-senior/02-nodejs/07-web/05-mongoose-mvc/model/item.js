...
* @Last Modified time: 2019-07-31 08:24:37
*/
const fs = require('fs')
...
const mode = require(path.normalize(__dirname+"/../mongoose/mongoose"))

const readFile = util.promisify(fs.readFile);
const writeFile = util.promisify(fs.writeFile);

async function get(action){
	// mode[action] && mode[action]("get")
	const data = await mode[action]("get");
